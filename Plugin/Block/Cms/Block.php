...
namespace Girit\LazyLoad\Plugin\Block\Cms;
...
class Block
{
    ...
    {
        if (!$this->_giritLazyLoadHelper->isEnabled() || !$this->_giritLazyLoadHelper->isAutoReplaceCmsBlocks() || in_array($subject->getBlockId(), $this->_giritLazyLoadHelper->getIgnoredCmsBlocksArray())) {
            return $html;
        }
